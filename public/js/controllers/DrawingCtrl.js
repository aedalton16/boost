...
var $ = require('jquery');
var CanvasWrapper = require('../fabric_custom/CanvasWrapper');

var DrawingCtrl = function($scope, $route, $routeParams, Drawing, socket, sharedProperties){
  ...
  $scope.init = function(){
    ...
    // render our drawing 
    Drawing.get({drawingId: $routeParams.drawingId}, function(drawing){
